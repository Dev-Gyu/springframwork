package com.coderby.myapp.employees.valueobject;
...
public class EmpVO {
	...
	@Pattern(regexp="[A-Z0-9]{2,}", message="영문 대문자 숫자를 이용해 두자리 이상")
	...
	@DecimalMin(value="0.00", message="보너스 >= 0.0")
	@DecimalMax(value="0.99", message="보너스 < 1")
